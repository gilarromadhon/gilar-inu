...
function App() {
  return (
    ...
    <section class="bg-white dark:bg-gray-800">
        <nav class="container p-6 mx-auto lg:flex lg:justify-between lg:items-center">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href="#">GilarInu</a>
                </div>
        ...
        <div class="container px-6 py-16 mx-auto text-center">
            <div class="max-w-lg mx-auto">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl">Gilar-Inu adalah penjual koin yang berkualitas dan bersahabat</h1>
                <p class="mt-6 text-gray-500 dark:text-gray-300">Beli disini dengan pajak yang rendah dan harga yang tinggi.</p>
                <button
                ...
                <p class="mt-3 text-sm text-gray-400 ">Jangan Telfon (Wa Only)</p>
            </div>
    ...
    <section class="bg-gray-100 dark:bg-gray-100 lg:py-12 lg:flex lg:justify-center">
        <div class="bg-white dark:bg-gray-800 lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
            ...
            <div class="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-1/2">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white md:text-3xl">Mau<span class="text-blue-600 dark:text-blue-400"> Mencobanya?</span></h2>
                <p class="mt-4 text-gray-600 dark:text-gray-400">Cobalah untuk beli koin disini dengan tidak ada minimal berapapun dengan kualitas koin yang masih mencling dan bisa digunakan untuk wasit atau memberi pak ogah.</p>
                
                <div class="mt-8">
                    <a href="#" class="px-5 py-2 font-semibold text-gray-100 transition-colors duration-200 transform bg-gray-900 rounded-md hover:bg-gray-700">Beli Sekarang</a>
                </div>
            </div>
        </div>
    </section> 
    ...
    <section class="bg-white dark:bg-gray-800 mt-10">
            <div class="container px-6 py-10 mx-auto">
                <div class="lg:flex lg:items-center">
                    <div class="w-full space-y-12 lg:w-1/2 ">
                        <div>
                            <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Keunggulan<br /> Koin Disini</h1>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Bukan Sembarang Koin</h1>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Bisa Ditukar Kembali</h1>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Bisa dark mode</h1>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-10 mx-auto">
                <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Silahkan dipilih<br /> Paketnya. <span class="underline decoration-blue-500"> Mumpung Promo</span></h1>
                
                <p class="mt-4 text-gray-500 xl:mt-6 dark:text-gray-300">
                    Gak usah lama lama, kalo lama itu jodoh anda.
                </p>
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                    <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                        ...
                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Paket Miskin</h1>

                        <p class="text-gray-500 dark:text-gray-300">
                            Anda mendapatkan 5 koin 1000 dan 5 koin 500.
                        </p>
                    ...
                    <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                        ...
                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Paket Abis Gajian</h1>

                        <p class="text-gray-500 dark:text-gray-300">
                          Anda mendapatkan 10 koin 1000 dan 10 koin 500.
                        </p>
                    ...
                    <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                        ...
                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Paket Sultan</h1>

                        <p class="text-gray-500 dark:text-gray-300">
                          Anda mendapatkan 20 koin 1000 dan 20 koin 500.
                        </p>
        ...
        <div class="container px-6 py-4 mx-auto">
            <div class="lg:flex">
                <div class="w-full -mx-6 lg:w-2/5">
                    <div class="px-6">
                        <div>
                            <a href="#" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Gilar-Inu</a>
                        </div>
            ...
            <div>
                <p class="text-center text-gray-800 dark:text-white">© Gilar-Inu 2022 - All rights reserved</p>
            </div>
        </div>
    </footer>
    </div>
